      ...
      <div class="col">
        <form action="./includes/register.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" id="exampleFormControlInput1" placeholder="Jelszó újra" name="confirmpassword" required>
            <br>
            <button type="submit" name="confirm" class="btn btn-dark">regisztráció</button>
